function dataTable2 = BackwardSmoothTheAudioClipsSparseMatrix( sparseCoefficientMatrix, dataTable1, varargin)
%
%   Input:: 
...
%       dataTable2 
    ...
    gaussianTableLast= CreateTheGaussianTable(maxSparseCoefficientMatrix_Last, sigma); 
    envelopeLast = max(gaussianTableLast,[],2); 
    envelope_i = envelopeLast; 
