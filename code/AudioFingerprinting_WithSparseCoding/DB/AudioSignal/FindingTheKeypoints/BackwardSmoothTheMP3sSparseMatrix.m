function dataTable2= BackwardSmoothTheMP3sSparseMatrix(SparseCoefficientMatrix, dataTable1, varargin)
%
%   Input:: 
...
%       dataTable2 
    ...
    gaussianTable_Last= max(maxSparseCoefficientMatrix_Last,[],2);
