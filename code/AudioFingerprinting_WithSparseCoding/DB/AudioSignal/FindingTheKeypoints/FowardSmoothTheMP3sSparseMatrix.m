function dataTable1= FowardSmoothTheMP3sSparseMatrix(SparseCoefficientMatrix, varargin)
%
%   Input::
...
%       dataTable1
    ...
    envelope_N=max(gaussianTable_N,[],2); 
    envelope_i= envelope_N; 
    ...
    for i=1:size(sparseCoefficientMatrix,2)
        ...
        [peaks_i , ~ ]= FindTheLocalMaximasOfTheVector(sparseCoefficientMatrix_i); 
